                    ...
                    <div class="data">
                        ...
                        <table class="line-tb">
                            ...
                            <tr>
                                ...
                                <th class="w-130">地址</th>
                                <th class="w-80">电话</th>
                                <th class="w-80">微信</th>
                                <th class="w-100">车辆</th>
                                <th class="w-80">状态</th>
                            ...
                            <tr v-for="v in data" :key="v.id" :data-id="v.id" @click="selectEvent">
                                ...
                                <td class="multiple-rows">
                                    <div class="row">【价格】<b>${{ v.price }}</b></div>
                                    <div class="row">【vin】<b>{{ v.vin }}</b></div>
                                    <div class="row">【里程】<b>{{ v.mileage }}英里</b></div>
                                    <div class="row">【车身颜色】<b>{{ v.color }}</b></div>
                                    <div class="row">【内饰颜色】<b>{{ v.interior_color }}</b></div>
                                </td>
