                    ...
                    <div class="data">
                        <div class="run-title">
                            ...
                            <div class="right">
                                ...
                                <button type="button" class="run-button run-button-blue" @click="location('/detectionModule/add' , {mode: 'add'})">
                        ...
                        <table class="line-tb">
                            ...
                            <tr v-for="v in data" :key="v.id" :data-id="v.id" @click="selectEvent">
                                ...
                                <td>{{ v.create_time }}</td>
                                <td>
                                    <button type="button" class="run-button run-button-blue" @click.stop="location('/detectionModule/edit' , {id: v.id , mode: 'edit'})">
