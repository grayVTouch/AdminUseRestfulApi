                    ...
                    <div class="data">
                        <div class="run-title">
                            ...
                            <div class="right">
                                ...
                                <button type="button" class="run-button run-button-blue" @click="location('/story/add' , {mode: 'add'})">
                        ...
                        <table class="line-tb">
                            ...
                            <tr>
                                ...
                                <th class="w-40">ID</th>
                                <th class="w-80">标题</th>
                                <th class="w-80">用户名</th>
                                <th class="w-120">图片</th>
                                <th class="w-120">内容</th>
                                <th class="w-80">评分</th>
                                <th class="w-40">是否隐藏</th>
                                <th class="w-30">
                                    权重
                                    <span class="arrow">
                            ...
                            <tr v-for="v in data" :key="v.id" :data-id="v.id" @click="selectEvent">
                                ...
                                <td>{{ v.create_time }}</td>
                                <td>
                                    <button type="button" class="run-button run-button-blue" @click.stop="location('/story/edit' , {id: v.id , mode: 'edit'})">
