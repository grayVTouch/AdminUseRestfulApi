                    ...
                    <div class="data">
                        <div class="run-title">
                            ...
                            <div class="right">
                                ...
                                <button type="button" class="run-button run-button-blue" @click="location('/carConfiguration/add' , {mode: 'add'})">
                        ...
                        <table class="line-tb">
                            ...
                            <tr>
                                ...
                                <th class="w-100">分组</th>
                                <th class="w-120">图片</th>
                                <th class="w-130">描述</th>
                                <th class="w-30">
                                    权重
                                    <span class="arrow">
                            ...
                            <tr v-for="v in data" :key="v.id" :data-id="v.id" @click="selectEvent">
                                ...
                                <td>{{ v.create_time }}</td>
                                <td>
                                    <button type="button" class="run-button run-button-blue" @click.stop="location('/carConfiguration/edit' , {id: v.id , mode: 'edit'})">
