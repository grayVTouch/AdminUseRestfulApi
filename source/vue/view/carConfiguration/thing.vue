            ...
            <div class="in">
                <form @submit.prevent="submit">
                    <table class="input-tb">
                        ...
                        <tr id="car_configuration_group_id" :class="getClass(error.car_configuration_group_id)">
                            <td>配置分组</td>
                            <td>
                                <i-select v-model="form.car_configuration_group_id" style="width: 300px;">
                                    <i-option v-for="v in group" :key="v.id" :value="v.id">{{ v.name }}</i-option>
                                </i-select>
                                <span class="necessary">*</span>
                                <span class="tip"></span>
                                <span class="msg">{{ error.car_configuration_group_id }}</span>
                            </td>
                        </tr>
                        ...
                        <tr id="desc" :class="getClass(error.desc)">
                            <td>描述</td>
                            <td>
                                <textarea v-model="form.desc" class="form-textarea"></textarea>
                                <span class="necessary"></span>
                                <span class="tip"></span>
