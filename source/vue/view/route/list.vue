                ...
                <div class="top">
                    ...
                    <form @submit.prevent="submit" @reset="reset">
                        ...
                        <div class="filter-options">
                            ...
                            <div class="option">
                                <div class="field">上级路由：</div>
                                <div class="value">
                                    <v-select v-model="form.p_id" :data="all" :width="200"></v-select>
                                </div>
                            </div>
                            <div class="option">
                    ...
                    <div class="data">
                        <div class="run-title">
                            ...
                            <div class="right">
                                ...
                                <button type="button" class="run-button run-button-blue" @click="location('/route/add' , {mode: 'add'})">
                        ...
                        <table class="line-tb">
                            ...
                            <tr>
                                ...
                                <th class="w-30">方法</th>
                                <th class="w-30">类型</th>
                                <th class="w-20">是否启用</th>
                                <th class="w-20">是否隐藏</th>
                                <th class="w-20">是否菜单</th>
                                <th class="w-30">权重</th>
                            ...
                            <tr v-for="v in data" :key="v.id" :data-id="v.id" @click="selectEvent">
                                ...
                                <td>{{ v.create_time }}</td>
                                <td>
                                    <button type="button" class="run-button run-button-blue" @click.stop="location('/route/edit' , {id: v.id , mode: 'edit'})">
